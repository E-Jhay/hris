...
// 	$.ajax({
// 		url:"controller/controller.additional_documents.php?selectEmployee",
// 		method:"POST",
// 		data:{
// 			emp_id:emp_id
...
// 	e.preventDefault();
// 	confirmed("save",save_callback, "Do you aaaareally want to save this?", "Yes", "No");
...
// $.ajax({
//   url:"controller/controller.additional_documents.php?editcontactemp",
//   method:"POST",
//   data: $('form').serialize(),
//   success:function(data){
// 	  var b = $.parseJSON(data);
