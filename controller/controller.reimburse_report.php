    ...
    if($type=="all"){
      ...
      if($statuss==""){
        $query = $conn->prepare("SELECT a.*,b.lastname,b.firstname,b.reimbursement_bal FROM tbl_reimbursement a
                               LEFT JOIN tbl_employee b ON a.employeeno=b.employeeno ORDER BY a.datee ASC");
      }else {
        $query = $conn->prepare("SELECT a.*,b.lastname,b.firstname,b.reimbursement_bal FROM tbl_reimbursement a
                               LEFT JOIN tbl_employee b ON a.employeeno=b.employeeno WHERE a.statuss='$statuss' ORDER BY a.datee ASC");
      }
      
    }else if($type="personal"){
      $query = $conn->prepare("SELECT a.*,b.lastname,b.firstname,b.reimbursement_bal FROM tbl_reimbursement a
                               LEFT JOIN tbl_employee b ON a.employeeno=b.employeeno WHERE a.employeeno='$employeeno' ORDER BY a.datee ASC");
    }
    $query->execute();
    $row = $query->fetchAll();
    $return = array();
