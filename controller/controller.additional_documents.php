...
class crud extends db_conn_mysql
{
  function selectAdditionalDocuments(){
    ...
    $data = array();
    $return = array();
    $data['marriage_contract'] = $marriage_contract_data['marriage_contract'] ? '<button onclick="viewDocument(\''.$marriage_contract_data['marriage_contract'].'\',\''.$employeeno.'\')" class="btn btn-sm btn-success"><i class="fas fa-sm fa-download"></i> View</button>' : '<p>N/A</p>';
    $data['dependent'] = $dependent_data['dependent'] ? '<button onclick="viewDocument(\''.$dependent_data['dependent'].'\',\''.$employeeno.'\')" class="btn btn-sm btn-success"><i class="fas fa-sm fa-download"></i> View</button>' : '<p>N/A</p>';
    $data['additional_id'] = $additional_id_data['additional_id'] ? '<button onclick="viewDocument(\''.$additional_id_data['additional_id'].'\',\''.$employeeno.'\')" class="btn btn-sm btn-success"><i class="fas fa-sm fa-download"></i> View</button>' : '<p>N/A</p>';
    $data['proof_of_billing'] = $proof_of_billing_data['proof_of_billing'] ? '<button onclick="viewDocument(\''.$proof_of_billing_data['proof_of_billing'].'\',\''.$employeeno.'\')" class="btn btn-sm btn-success"><i class="fas fa-sm fa-download"></i> View</button>' : '<p>N/A</p>';
    $return[] = $data;
