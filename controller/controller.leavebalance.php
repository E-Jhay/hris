...
class crud extends db_conn_mysql
{
  ...
  function leave_credits_load(){
      ...
      foreach ($row as $x){
        ...
        if($countsl <= 0){
          $q4 = $conn->prepare("INSERT INTO leave_balance SET employee_no='$employee_no',leave_type='SL',balance='0',earned='no',what_month='0'");
          $q4->execute();
        }

        if($countvl <= 0){
          $q4 = $conn->prepare("INSERT INTO leave_balance SET employee_no='$employee_no',leave_type='VL',balance='0',earned='no',what_month='0'");
          $q4->execute();
        }
